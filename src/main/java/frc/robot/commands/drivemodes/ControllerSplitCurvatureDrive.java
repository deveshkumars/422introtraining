 ...
 */
public class ControllerSplitCurvatureDrive extends CommandBase {
    ...
    public ControllerSplitCurvatureDrive() {
        setName("ControllerSplitCurvatureDrive");
    ...
    public void execute() {
        ...
        * for driveBase to the right stick X-axis on on the driverXboxController */
        ...
        pointTurning = UserInterface.driverController.getRightJoystickX() >= 0.4;
        ...
        Subsystems.driveBase.cheesyDrive.curvatureDrive(RobotMap.getSpeedCap() * speed, RobotMap.getRotationCap() * rotation, pointTurning);
    }
}